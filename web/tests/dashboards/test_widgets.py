...
def test_list_widgets():
    ...
    # Mock Widget.__subclasses__ to return our mock widgets
    with patch(
        ...
        # Verify the content of each widget entry
...
def test_widget_validate_type():
    ...
    # Mock list_widgets to return our mock widgets
...
def test_views_widget_index(
    ...
    """
    Test ViewsWidget.index to ensure correct views are returned based on privacy and ownership.
    """
    # --- Setup ---
...
def test_view_cves_widget_index(
    ...
    create_organization,
    create_view,
    create_cve,  # Add create_cve fixture
):
    """
...
def test_project_cves_widget_index(
    ...
    # --- Test Case 1: Project with TomExam Subscriptions ---
    widget = ProjectCvesWidget(
        mock_request,
        {
            "id": "b1c2d3e4-f5a6-b7c8-d9e0-f1a2b3c4d5e6",
    ...
    # --- Test Case 2: Project with No Subscriptions ---
